  ...
  <nav>
    <h1>
      ...
      <span class="lt-sm-hidden">
        <span>ElTableNext Playground</span>
      </span>
    </h1>
    ...
    <el-space class="links">
      <div v-for="(v, key) of versions" :key="key" class="flex items-center lt-lg-hidden">
        ...
        <el-select :model-value="v.active" size="small" fit-input-width class="mr-2 w-36"
      ...
      <button title="View on GitHub" class="github">
        <a href="https://github.com/jackluson/el-table-next-playground" target="_blank">
          <github />
        </a>
      </button>
    </el-space>
